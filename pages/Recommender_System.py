...
selected_location = st.selectbox('Landmark',sorted(location_df.columns.to_list()))
...
if st.button('Search'):
    ...
    if not result_ser.empty:
        ...
        st.text('No properties nearby. Please select a larger radius or a different landmark.')
